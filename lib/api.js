...
export class RealtimeAPI extends RealtimeEventHandler {
  ...
  async connect() {
    ...
    const fullUrl = `${this.url}?api-version=2024-12-17-preview&deployment=${this.deploymentName}&api-key=Cwfj5nih4rUog5tSsKagj7Dsl4HkEMq3X3UzXriCsu5srJ1cZarLJQQJ99BAACHYHv6XJ3w3AAAAACOG8UXh`;
